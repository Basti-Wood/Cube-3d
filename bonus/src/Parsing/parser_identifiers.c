...
int	parse_texture_identifier(char *id, char *value, t_game *game)
{
	...
	else if (ft_strncmp(id, "BARREL", 7) == 0)
	...
	else if (ft_strncmp(id, "TREE1", 6) == 0)
		return (handle_texture(TREE_0, "TREE1", value, game));
	else if (ft_strncmp(id, "TREE2", 6) == 0)
		return (handle_texture(TREE_1, "TREE2", value, game));
	else if (ft_strncmp(id, "TREE3", 6) == 0)
		return (handle_texture(TREE_2, "TREE3", value, game));
	else if (ft_strncmp(id, "TREE4", 6) == 0)
		return (handle_texture(TREE_3, "TREE4", value, game));
	else if (ft_strncmp(id, "TREE5", 6) == 0)
		return (handle_texture(TREE_4, "TREE5", value, game));
	return (-1);
}
